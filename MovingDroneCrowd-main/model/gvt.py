...
class VisionTransformer(nn.Module):
    def __init__(self, patch_size=16, in_chans=3, embed_dim=1024, depth=24, num_heads=16,
...
class CViTV2(VisionTransformer):
    def __init__(self, patch_size=16, in_chans=3, embed_dims=256, depths=12, num_heads=12, mlp_ratios=4.,
...
class pcvit_base(CViTV2):
    def __init__(self, **kwargs):
        super(pcvit_base, self).__init__(
            patch_size=16, embed_dims=256, num_heads=8, depths=6, mlp_ratios=4,
