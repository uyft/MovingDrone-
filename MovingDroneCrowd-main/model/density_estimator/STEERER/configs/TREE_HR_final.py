...
test = dict(
    ...
    model_file= './exp/TREE/MocHRBackbone_hrnet48/TREE_HR_base_2022-10-29-14-12/final_state.pth'#Ep_164_mae_8.219119112570207_mse_11.332124376085398.pth'
)
