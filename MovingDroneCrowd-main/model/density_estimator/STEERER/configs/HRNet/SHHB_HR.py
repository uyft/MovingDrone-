...
test = dict(
    ...
    model_file='./exp/SHHB/MocHRBackbone_hrnet48/SHHB_mocHR_small_2022-09-23-19-54/Ep_181_mae_6.4759475128560124_mse_10.298928940304311.pth'
)
