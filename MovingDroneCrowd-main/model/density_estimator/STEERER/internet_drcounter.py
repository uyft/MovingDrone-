...
class InterNet(nn.Module):
    def __init__(self):
        ...
        cfgs = {
            ...
            'floor_x8': {
                'down3': {'layer_num': 1, 'in_chanel': 64, 'out_chanel': 64},
                'stage1': {'layer_num': 3, 'in_chanel': 64, 'out_chanel': 64},
                'stage2': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64},
                'stage3': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64},
                'stage4': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64}
            ...
            'floor_x16': {
                'down4': {'layer_num': 1, 'in_chanel': 64, 'out_chanel': 64},
                'stage1': {'layer_num': 2, 'in_chanel': 64, 'out_chanel': 64},
                'stage2': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64},
                'stage3': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64},
                'stage4': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64}
            ...
            'floor_x32': {
                'down5': {'layer_num': 1, 'in_chanel': 64, 'out_chanel': 64},
                'stage1': {'layer_num': 1, 'in_chanel': 64, 'out_chanel': 64},
                'stage2': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64},
                'stage3': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64},
                'stage4': {'layer_num': 4, 'in_chanel': 64, 'out_chanel': 64}
        ...
        self.last_layer1 = CountingHead(64,  [64, 32,16],1)
        self.last_layer2 = CountingHead(64,  [64, 32,16],1)
        self.last_layer3 = CountingHead(64,  [64, 32,16],1)
        self.last_layer4 = CountingHead(64,  [64, 32,16],1)
    ...
    def forward(self,x):
        ...
        x1 = self.last_layer1(x1) #1/4
        x2 = self.last_layer2(x2)
        x3 = self.last_layer3(x3)
        x4 = self.last_layer4(x4) #/32
