...
class HrnetBasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, drop_path=0., expansion=4, stride=1, downsample=None):
        ...
        #      planes * expansion, planes, kernel_size=1, bias=False
        # )
...
class Bottleneck(nn.Module):
    def __init__(self, inplanes, planes, drop_path=0., stride=1, downsample=None,expansion=4):
