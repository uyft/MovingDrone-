...
parser.add_argument('--train-limit', dest='train_limit', default=0, type=int,
                    help='maximum number of sorted training images; 0 uses all')
parser.add_argument('--val-limit', dest='val_limit', default=0, type=int,
                    help='maximum number of sorted validation images; 0 uses all')
...
def main():
    ...
    if args.train_limit > 0:
        train_list = train_list[:args.train_limit]
    train_clip = []
    train_step = 0
    ...
    test_list.sort()
    if args.val_limit > 0:
        test_list = test_list[:args.val_limit]
    print('Using {} training and {} validation images'.format(
